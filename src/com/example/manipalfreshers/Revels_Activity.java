...
public class Revels_Activity extends Activity {
		   ...
		   @Override
		    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		    	...
		    	if (s.equalsIgnoreCase("Home")){
					...
					Intent i = new Intent(Revels_Activity.this,Contact_us_Activity.class);
					startActivity(i);
				}
				Toast.makeText(Revels_Activity.this, s, Toast.LENGTH_LONG).show();
