...
@SuppressLint("NewApi") public class Contact_us_Activity extends Activity {
	...
	private class DrawerItemClickListener implements ListView.OnItemClickListener {
		    ...
		    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		    	...
		    	if (s.equalsIgnoreCase("Home")){
		    		...
		    		Intent i = new Intent(Contact_us_Activity.this,Websis_Activity.class);
		    		startActivity(i);
		    	}
		    	else if (s.equalsIgnoreCase("manipal.edu")){
		    		Intent i = new Intent(Contact_us_Activity.this,Website_Activity.class);
		    		startActivity(i);
		    	}
		    	else if (s.equalsIgnoreCase("mitfiles.com")){
		    		Intent i = new Intent(Contact_us_Activity.this,MitFiles_Activity.class);
		    		startActivity(i);
		    	}
		    	else if (s.equalsIgnoreCase("MTTN")){
		    		Intent i = new Intent(Contact_us_Activity.this,MTTN_Activity.class);
		    		startActivity(i);
		    	}
		    	else if (s.equalsIgnoreCase("TechTatva")){
		    		Intent i = new Intent(Contact_us_Activity.this,Techtatva_Activity.class);
		    		startActivity(i);
		    	}
		    	else if (s.equalsIgnoreCase("Revels")){
		    		Intent i = new Intent(Contact_us_Activity.this,Revels_Activity.class);
		    		startActivity(i);
		    	}
		    	else if (s.equalsIgnoreCase("StudentCouncil")){
		    		Intent i = new Intent(Contact_us_Activity.this,Student_council_Activity.class);
		    		startActivity(i);
		    	}
		        
		    	else if (s.equalsIgnoreCase("Manipal Blog")){
		    		Intent i = new Intent(Contact_us_Activity.this,Manipal_blog_Activity.class);
		    		startActivity(i);
		    	}
		    	...
		    	Toast.makeText(Contact_us_Activity.this, s, Toast.LENGTH_LONG).show();
